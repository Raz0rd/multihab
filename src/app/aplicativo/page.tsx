...
export default function AplicativoPage() {
  ...
  return (
    <GovLayout userName={userName} breadcrumbItems={['Cadastro', 'Aplicativo']}>
      <div className="w-full">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="flex items-center justify-center w-6 h-6 rounded-full bg-[#1351B4] text-white text-sm font-medium">2</div>
            <p className="font-semibold text-base">Acesso ao Aplicativo</p>
          </div>
